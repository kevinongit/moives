...
export const movieReviewsJSON = {
  1: [
        ...
        {"id":1,"fresh":true,"text":"The first 40 minutes of the movie contain the most giddy and intoxicating action scenes you'll find in any cinema this summer."},
        ...
        {"id":4,"fresh":true,"text":"Returning to the fray after missing the first sequel, John McTiernan directs with a gleeful disregard for narrative logic, especially in the closing stages. It's cracking entertainment, though."},
  ...
  2: [
        {"id":0,"fresh":true,"text":"Overall, the film is one of a kind, a masterpiece and a work of art so to speak. The superior musical score that accompanies the film heightens the suspense and adds to the mystery sequences."}, 
        ...
        {"id":4,"fresh":true,"text":"A mind-bending thriller that is a complete original, cementing Nolan's status as one of this generation's brightest filmmakers."},
  ...
  3: [
        {"id":0,"fresh":true,"text":"There's always too much going on, which is easily forgivable for a while. But as the minutes mount, the flaws are only accentuated."}, 
        {"id":1,"fresh":true,"text":"Ahoy mateys! Shiver me timbers, I think we have a winner here!"}, 
        {"id":2,"fresh":true,"text":"'Pirates of the Caribbean: The Curse of the Black Pearl' remains a rarity among this summer's movies in that it not only meets audience expectations, it exceeds them."},
        {"id":3,"fresh":true,"text":"This is about 45 minutes too long but it still holds up as a rousing old-school adventure movie like you might have gotten with Errol Flynn back in the day."},
  ...
  4: [
        ...
        {"id":1,"fresh":true,"text":"You would think they would go back to a time when Thanos was young and vulnerable and off him. They opt for a more intricate approach, which bored me."},
        ...
        {"id":3,"fresh":true,"text":"As expected, the film is carried by the original six Avengers, but it does a remarkable job of bringing virtually every memorable character from all 22 movies back onto the screen. It is a staggering reminder of past and present pleasures."},
  ...
  5: [
        {"id":0,"fresh":true,"text":"Go see it on the biggest screen possible and let the little kid in you enjoy every moment of it."},
        {"id":1,"fresh":true,"text":"Overall, this is a profoundly satisfying episode without apparent weak spots (it's a notch disjointed, but nothing unbearable): You'll laugh, cry and be in awe..."},
        ...
        {"id":3,"fresh":true,"text":"The structure, at times, is similar to 30-minute episodes of a miniseries event that we're binge watching. And while some of the visual effects and cinematography are stunning, something is lacking overall."},
        {"id":4,"fresh":true,"text":"Johnson unleashed one of the most spectacular visual feats within the Star Wars universe."},
  ...
  6: [
        {"id":0,"fresh":true,"text":"...non-stop, pulsating action that permeates through every frame."},
        ...
        {"id":2,"fresh":true,"text":"As far as decent popcorn movies go, M:I-GP is a nice entry for 2012 - entertaining and thrilling."},
        ...
        {"id":5,"fresh":true,"text":"Big. Bold. Breathtaking. I hope the team chooses to accept another mission."},
      ],
  7: [
        ...
        {"id":4,"fresh":true,"text":"Full to the brim with eye-popping effects and \"How'd they do that?\" stuntwork, it yearns to have audiences be utterly enraptured in its created reality."},
